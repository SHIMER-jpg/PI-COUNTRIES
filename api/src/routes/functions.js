...
module.exports={
    loadDataBase: (json)=>{
        ...
        json.forEach(country=>{
            var {alpha3Code,name,flag,region,subregion,area,population,capital} = country
    ...
    loadActivities: ()=>{
        ...
        dummyActivities.forEach( async activity=>{
            const {name,difficulty,duration,seasonArray,description,countries} = activity;
